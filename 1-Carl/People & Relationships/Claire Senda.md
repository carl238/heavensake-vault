...
- **AI adoption:** Being trained and onboarded on Perplexity Computer, Meta Ads Manager integration, AI content tools. Carl is actively sharing AI resources with her.
- **Brand bible:** Claire is tasked with drafting the brand book using AI tools — integrating core company values and website tone.
- **10th Anniversary (June 6–7, Monaco):** Major logistics responsibility — managing production and shipping of large items (Daruma, Taru), vendor communications for fans (with Maxime), and clothing supplier coordination with Gloria.
- **Supplier communications:** Taking over 224 Porcelain contact for Xuan Cups production once Carl provides the contact; managing Daruma face design (Tennosaki front, "luck" back in kanji, coordinating with Mommy on calligraphy style).
- **Transition:** Helping cover Giancarlo Cappelletti's digital marketing work from end of March 2026.
