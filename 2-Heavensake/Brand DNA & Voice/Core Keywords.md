...
source: notion + carl-direct
tags: [brand-dna, founder-voice, keywords]
---

# Core Keywords

These keywords define the emotional, philosophical, and conceptual territory HEAVENSAKE owns. They operate at two levels: **six philosophical pillars** (the brand's deepest DNA, from Carl directly) and **ten brand keywords** (the emotional territory for campaigns and copy).

Every campaign, piece of copy, and visual direction should be traceable to one or more of these words.
...
These are the words that define what HEAVENSAKE stands for — not as marketing vocabulary, but as philosophical pillars. Each carries strategic intent.
...
All six pillars must be present in every major brand expression. If a campaign has elegance but no playfulness — it's too cold. If it has celebration but no culture — it's shallow. If it has music but no joie de vivre — it's just noise.

---

## The 10 Brand Keywords

These define the emotional territory for campaigns and copy. Every piece of content should make the audience feel one or more of these.
...
The 6 philosophical pillars are the **strategic compass** — they guide brand direction and partnerships.

The 10 brand keywords are the **creative lens** — they guide content, campaigns, and copy.

Ask: *Which of these does this content make the reader feel?* If the answer is none, reconsider the direction.

Cross-reference with [[The Lexicon]] for the seed phrases that activate each keyword in copy.
Cross-reference with [[Never Say List]] for the words and phrases that undermine these keywords.
